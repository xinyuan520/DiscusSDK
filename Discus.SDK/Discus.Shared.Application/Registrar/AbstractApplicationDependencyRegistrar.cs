...
namespace Discus.Shared.Application.Registrar
{
    public abstract class AbstractApplicationDependencyRegistrar : IDependencyRegistrar
    {
        ...
        public IConfigurationSection NacosSection { get; set; }

        public IConfigurationSection ElasticSearchSection { get; set; }
        ...
        public AbstractApplicationDependencyRegistrar(IServiceCollection services)
        {
            ...
            NacosSection = Configuration.GetSection(NodeConsts.Nacos);
            ElasticSearchSection = Configuration.GetSection(NodeConsts.ElasticSearch);
        }
        ...
        protected virtual void AddEventBusCap()
        {
            ...
            Services.AddEventBusCap(option =>
            {
                ...
                {
                    config.ConnectionString = mysqlConfig.MasterConnectionString;
                ...
                option.UseRabbitMQ(option =>
                {
                    ...
                    option.ExchangeName = ServiceInfo.ServiceName;
